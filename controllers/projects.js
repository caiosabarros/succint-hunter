...
const getAll = async (req, res, next) => {
    try {
        ...
        if (!projects) throw createError(500, "We're unable to check the database");
...
const createProject = async (req, res, next) => {
    try {
        ...
        if (response.acknowledged > 0) {
            ...
            throw createError(500, "Unable to create a project in the database");
...
const updateProject = async (req, res, next) => {
    try {
        ...
        if (response.modifiedCount > 0) {
            ...
            throw createError(500, "Error updating project");
...
const deleteProject = async (req, res, next) => {
    ...
    try {
        ...
        if (response.deletedCount > 0) {
            ...
            throw createError(500, "Error deleting project");
